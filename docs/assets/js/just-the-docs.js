...
{"0": {
    ...
    "url": "http://localhost:4000/gfx_apps_sam_9x60/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "Example Applications",
    "title": "Example Applications",
    "content": "The following applications are provided to demonstrate both basic and advanced Graphics capabilities of the SAM 9x60 Family. An OV5640 CMOS camera module example is provided to demonstrate the usage of the SAM9X60 Image Sensor Interface. ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/readme.html",
    ...
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/readme.html#legato-library-examples",
    ...
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/readme.html#blank-library-examples",
    ...
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/readme.html#lvgl-library-examples",
    "relUrl": "/apps/readme.html#lvgl-library-examples"
  },"5": {
    "doc": "Example Applications",
    "title": "Camera Examples",
    "content": ". | ISI Camera | . This application uses the OV5640 arducam camera module to demonstrate the usage of the SAM9X60-EK ISI interface. ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/readme.html#camera-examples",
    "relUrl": "/apps/readme.html#camera-examples"
  },"6": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_9x60/images/mhgs.png) Microchip MPLAB® Harmony 3 Graphics Application Examples for SAM 9x60 Family # Microchip MPLAB® Harmony 3 Release Notes ## MPLAB® Harmony 3 Graphics Application Examples for SAM 9x60 Family v3.12.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------|:-------------------:| [SAM 9x60 Evaluation Kit](https://www.microchip.com/en-us/development-tool/DT100126) | 8 | [SAM9X60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) | 8 | ## Release v3.12.0 ### New Features New features added in this release are as follows: - Added LVGL Showcase to WVGA configuration for SAM9x60 Curiosity Board ### Known Issues The current known issues are as follows: - For all IAR configurations, make sure LE_DYNAMIC_VTABLES is define to 1 to ensure build success - For proper GFX2D support, some configurations will require the data buffer memory definted in no_cache region, ie. SECTION(\\\".region_nocache\\\") definition for _dataBuffers in legato_renderer.c ### Development Tools - [MPLAB® X IDE v6.20](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v4.35](https://www.microchip.com/mplab/compilers) - MPLAB® X IDE plug-ins: - [MPLAB® Code Configurator (MCC) Plugin v5.4.1](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® Code Configurator (MCC) Core v5.6.1](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). ### Dependent Components * [GFX v3.14.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.14.0) ## Release v3.11.0 ### New Features New features added in this release are as follows: - Added Blank Quickstart (Single-Buffered) WVGA configuration for SAM9x60 Curiosity Board - Added Blank Quickstart (Double-Buffered) WVGA configuration for SAM9x60 Curiosity Board - Added Blank Canvas Quickstart WVGA configuration for SAM9x60 Curiosity Board - Added Legato Canvas Quickstart WVGA configuration for SAM9x60 Curiosity Board - Added Legato Quickstart WVGA configuration for SAM9x60 Curiosity Board ## Release v3.10.0 ### New Features New features added in this release are as follows: - Added Burst mode support for DMA when double-buffer is enabled - Added a camera (OV5640) example using the ISI interface - Added support for MPLAB Code Configurator ## Release v3.9.3 ### New Features New features added in this release are as follows: - Added Blank Quickstart (Single-Buffered) WVGA configuration - Added Blank Quickstart (Double-Buffered) WVGA configuration - Added Blank Canvas Quickstart WVGA configuration - Added Legato Canvas Quickstart WVGA configuration ## Release v3.9.2 ### New Features New features added in this release are as follows: - Added Legato Quickstart WVGA configuration with 270 Orientation ## Release v3.9.1 ### Issues Fixed - Fixed issues with packages and documentation ## Release v3.9.0 ### New Features New features added in this release are as follows: - Added Legato Quickstart WVGA configuration for IAR Embedded WorkBench - Added Legato Dashboard WVGA configuration with Graphics Canvas support ### Known Issues The current known issues are as follows: - For all IAR configurations, make sure LE_DYNAMIC_VTABLES is define to 1 to ensure build success - For proper GFX2D support, some configurations will require the data buffer memory definted in no_cache region, ie. SECTION(\\\".region_nocache\\\") definition for _dataBuffers in legato_renderer.c ### Development Tools - [MPLAB® X IDE v6.05 and above](https://www.microchip.com/mplab/mplab-x-ide) - MPLAB® X IDE plug-ins: - [MPLAB® Harmony Configurator (MHC) v3.8.5](https://www.microchip.com/en-us/tools-resources/configure/mplab-code-configurator). - [MPLAB® Code Configurator (MCC) v5.2.2](https://github.com/Microchip-MPLAB-Harmony/mplabx-plugin). - [MPLAB® XC32 C/C++ Compiler v4.20 and above](https://www.microchip.com/mplab/compilers) ### Dependent Components * [GFX v3.12.0](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.12.0) ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/release_notes.html",
    "relUrl": "/release_notes.html"
  },"7": {
    "doc": "Blank Canvas Quickstart",
    "title": "Blank Canvas Quickstart",
    "content": "# Blank Canvas Quickstart ![](/gfx_apps_sam_9x60/images/blank_canvas_qs.png) ![](/gfx_apps_sam_9x60/images/blank_canvas_qs_1.png) This application demonstrates a simple way to create and run a graphics application with a custom graphics library that directly uses the LCD controller driver. It also shows how to use the Canvas Graphics library. Touching anywhere on the LCD swaps the display image between the two pictures shown above. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[blank\\_cqs\\_9x60\\_ek\\_tm5000.X](/gfx_apps_sam_9x60/apps/blank_canvas_quickstart/firmware/blank_cqs_9x60_ek_tm5000.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)|[blank\\_cqs\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/blank_canvas_quickstart/firmware/blank_cqs_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/blank_canvas_quickstart/",
    "relUrl": "/apps/blank_canvas_quickstart/"
  },"8": {
    "doc": "Blank Quickstart",
    "title": "Blank Quickstart",
    "content": "# Blank Quickstart ![](/gfx_apps_sam_9x60/images/blank_quickstart.png) This application demonstrates a simple way to create and run a graphics application with a custom graphics library that directly uses the LCD controller driver. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[blank\\_qs\\_9x60\\_ek\\_tm5000.X](/gfx_apps_sam_9x60/apps/blank_quickstart/firmware/blank_qs_9x60_ek_tm5000.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)|[blank\\_qs\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/blank_quickstart/firmware/blank_qs_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/blank_quickstart/",
    "relUrl": "/apps/blank_quickstart/"
  },"9": {
    "doc": "Blank Quickstart with Double Buffering",
    "title": "Blank Quickstart with Double Buffering",
    "content": "# Blank Quickstart with Double Buffering ![](/gfx_apps_sam_9x60/images/blank_quickstart_db.png) ![](/gfx_apps_sam_9x60/images/blank_quickstart_db_1.png) This application demonstrates a simple way to create and run a graphics application with a custom graphics library that directly uses the LCD controller driver. It also shows how to use double buffering. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[blank\\_qs\\_db\\_9x60\\_ek\\_tm5000.X](/gfx_apps_sam_9x60/apps/blank_quickstart_db/firmware/blank_qs_db_9x60_ek_tm5000.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)|[blank\\_qs\\_db\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/blank_quickstart_db/firmware/blank_qs_db_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/blank_quickstart_db/",
    "relUrl": "/apps/blank_quickstart_db/"
  },"10": {
    "doc": "ISI Camera",
    "title": "ISI Camera",
    "content": "# ISI Camera ![](/gfx_apps_sam_9x60/images/ov5640_arducam.png) This demonstration shows how to use the SAM9X60-EK Image Sensor Interface peripheral with an off-the-shelf image sensor. For this example, an arducam OV5640 Camera Module is used. The application will store the captured images to a USB storage device in TGA format. When user pushes SW1 button, a full-size ISI codec capture is initiated and the image is stored in the USB storage device. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[isi\\_cam\\_sam9x60\\_ek.X](/gfx_apps_sam_9x60/apps/isi_camera/firmware/isi_cam_sam9x60_ek.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using the ISI interface to drive an off-the-shelf image sensor| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/isi_camera/",
    "relUrl": "/apps/isi_camera/"
  },"11": {
    "doc": "Legato Canvas Quickstart",
    "title": "Legato Canvas Quickstart",
    "content": "# Legato Canvas Quickstart ![](/gfx_apps_sam_9x60/images/legato_canvas_quickstart.png) This application shows how to use Canvas with Legato graphics library. A black rectangle is displayed with a logo and some fonts in layer one. This screen can be moved around with a swipe gesture using Canvas. Layer two has a grey panel with a button. Pressing the button moves the black rectangle back to home position. |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato\\_cqs\\_9x60\\_ek\\_tm5000.X](/gfx_apps_sam_9x60/apps/legato_canvas_quickstart/firmware/legato_cqs_9x60_ek_tm5000.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| [legato\\_cqs\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/legato_canvas_quickstart/firmware/legato_cqs_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/legato_canvas_quickstart/",
    "relUrl": "/apps/legato_canvas_quickstart/"
  },"12": {
    "doc": "Legato Dashboard",
    "title": "Legato Dashboard",
    "content": "# Legato Dashboard ![](/gfx_apps_sam_9x60/images/legato_dashboard.png) This application presents a vehicle dashboard User Interface (UI). It has a gauge to show the engine RPM (tachometer), dynamic text to show speed and distance traveled; and images for indicators like turn signals and other alerts. |MPLABX Configuration|Board Configuration|:-------------------|:------------------| [legato\\_db\\_9x60\\_ek\\_tm5000.X](/gfx_apps_sam_9x60/apps/legato_dashboard/firmware/legato_db_9x60_ek_tm5000.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| [legato\\_db\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/legato_dashboard/firmware/legato_db_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/legato_dashboard/",
    "relUrl": "/apps/legato_dashboard/"
  },"13": {
    "doc": "Legato Quickstart",
    "title": "Legato Quickstart",
    "content": "# Legato Quickstart ![](/gfx_apps_sam_9x60/images/legato_quickstart.png) This demonstration provides a touch-enabled starting point for the legato graphics library. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[legato\\_qs\\_9x60\\_ek\\_tm5000.X](/gfx_apps_sam_9x60/apps/legato_quickstart/firmware/legato_qs_9x60_ek_tm5000.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)|[legato\\_qs\\_9x60\\_ek\\_tm5000\\_270.X](/gfx_apps_sam_9x60/apps/legato_quickstart/firmware/legato_qs_9x60_ek_tm5000_270.X/)| [SAM 9x60 Evaluation Kit](https://www.microchip.com/developmenttools/ProductDetails/DT100126) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)|[legato\\_qs\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/legato_quickstart/firmware/legato_qs_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/legato_quickstart/",
    "relUrl": "/apps/legato_quickstart/"
  },"14": {
    "doc": "LVGL Showcase",
    "title": "LVGL Showcase",
    "content": "# LVGL Showcase ![](/gfx_apps_sam_9x60/images/lvgl_showcase.png) This application demonstrates a simple way to create a graphics application using the LVGL graphics library that directly uses the LCD controller driver. |MPLABX Configuration|Board Configuration|:-------------------|:------------------|[lvgl\\_sc\\_9x60\\_cu\\_tm5000.X](/gfx_apps_sam_9x60/apps/lvgl_showcase/firmware/lvgl_sc_9x60_cu_tm5000.X/)| [SAM 9x60 Curiosity Development Board](https://www.microchip.com/en-us/development-tool/EV40E67A) using LCDC internal graphics controller to drive the [High-Performance WVGA Display Module with maXTouch® Technology](https://www.microchip.com/DevelopmentTools/ProductDetails/PartNO/AC320005-5)| ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/apps/lvgl_showcase/",
    "relUrl": "/apps/lvgl_showcase/"
  },"15": {
    "doc": "Harmony 3 Graphics SAM 9x60 Applications Package",
    "title": "Harmony 3 Graphics SAM 9x60 Applications Package",
    "content": "# ![MPLAB® Harmony Graphics Suite](/gfx_apps_sam_9x60/images/mhgs.png) MPLAB® Harmony 3 Graphics Application Examples for SAM 9x60 Family MPLAB® Harmony Graphics Suite is an extension of the MPLAB® ecosystem for creating embedded graphics firmware solutions for Microchip 32-bit SAM and PIC microcontroller and microprocessor devices. Refer to the following links for more information. - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB® X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) - [MPLAB® Discover](https://mplab-discover.microchip.com/v1/itemtype/com.microchip.ide.project?s0=Legato) This repository contains the MPLAB® Harmony 3 Graphics application examples for SAM 9x60 Family. Graphics applications are standalone applications which demonstrate of some of the capabilities of MPLAB® Harmony Graphics Suite. Refer to the following links for release notes, home page, training materials, framework and application help. For more information on the tools, libraries and basic development with the MPLAB® Harmony Graphics Suite, please see the gfx repo also on github. - [Release Notes](/gfx_apps_sam_9x60/release_notes.html) - [MPLAB® Harmony License](/gfx_apps_sam_9x60/mplab_harmony_license.html) - [MPLAB® Harmony 3 Graphics User Guides Wiki](https://github.com/mchpgfx/legato.docs/wiki) - [MPLAB® Harmony 3 Graphics API Help](https://mchpgfx.github.io/legato.images/index.html) - [MPLAB® Harmony 3 Graphics Videos](https://www.youtube.com/playlist?list=PL9B4edd-p2ag5xsIIHhja-caKYY7AKPxe) - [MPLAB® Harmony 3 Graphics Suite Documentation](https://microchip-mplab-harmony.github.io/gfx/documentation.html) # Contents Summary | Folder | Description |------------|----------------------------------------------| apps | Example Graphics applications | docs | Contains files supporting documentation | Documentation is available for offline viewing. It can be used only after cloning this repository onto a local machine. For online viewing, please use [github pages](https://microchip-mplab-harmony.github.io/gfx_apps_sam_9x60/) of this repository. ## Graphics application examples (Blank) The following applications are provided to demonstrate the capabilities of Harmony Graphics Suite to support third-party graphics library. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps |[blank_quickstart_db](/gfx_apps_sam_9x60/apps/blank_quickstart_db/) | \\\"Blank\\\" Graphics Library Quickstart Example using Double Buffering | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | | [blank_quickstart](/gfx_apps_sam_9x60/apps/blank_quickstart/) | \\\"Blank\\\" Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | | [blank_canvas_quickstart](/gfx_apps_sam_9x60/apps/blank_canvas_quickstart/) | \\\"Blank\\\" Graphics Library and simple Canvas Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ## Graphics application examples (Legato) The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps | [legato_quickstart](/gfx_apps_sam_9x60/apps/legato_quickstart/) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | | [legato_dashboard](/gfx_apps_sam_9x60/apps/legato_dashboard/) | Legato Graphics Library and Canvas Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | | [legato_canvas_quickstart](/gfx_apps_sam_9x60/apps/legato_canvas_quickstart/) | Legato Graphics Library and simple Canvas Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | | [legato_benchmark](./apps/legato_benchmark/readme.md) | Legato Graphics Library Performance Benchmarking Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ## Graphics application examples (LVGL) The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps | [lvgl_showcase](/gfx_apps_sam_9x60/apps/lvgl_showcase/) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ## Camera application examples (ISI) The following application is provided to demonstrate the usage of the SAM9X60-EK ISI interface. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps |[isi_camera](/gfx_apps_sam_9x60/apps/isi_camera/) | Image Sensor Interface Example using OV5640 module | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_9x60/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Latest release date](https://img.shields.io/github/release-date/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.12.0) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/gfx_apps_sam_9x60.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_9x60/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/gfx_apps_sam_9x60.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() ",
    "url": "http://localhost:4000/gfx_apps_sam_9x60/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "gfx_apps_sam_9x60";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Graphics Applications PIC32CX SG40/60 Family";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gfx_apps_sam_9x60/assets/css/just-the-docs-' + theme + '.css');
}
