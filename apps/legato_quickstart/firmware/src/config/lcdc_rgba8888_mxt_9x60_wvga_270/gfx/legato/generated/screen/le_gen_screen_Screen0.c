...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_default_Layer0_FillPanel->fn->setSize(Screen0_default_Layer0_FillPanel, 480, 800);
    ...
    Screen0_LabelWidget2->fn->setPosition(Screen0_LabelWidget2, 287, 433);
    ...
    Screen0_LabelWidget1->fn->setPosition(Screen0_LabelWidget1, 162, 433);
    ...
    Screen0_LabelWidget0->fn->setPosition(Screen0_LabelWidget0, 47, 433);
    ...
    Screen0_ButtonWidget1->fn->setPosition(Screen0_ButtonWidget1, 113, 532);
    ...
    Screen0_ImageWidget1->fn->setPosition(Screen0_ImageWidget1, 81, 92);
